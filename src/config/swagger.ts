...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "API documentation for H2Oasis backend - Health & Wellness platform with wearable integration",
      contact: {
        name: "H2Oasis Team",
    ...
    tags: [
      ...
      {
        name: "Health Data",
        description: "Unified health data from wearables",
      },
      {
        name: "Products",
        description: "H2Oasis products (Cold Plunge, Hot Tub, Sauna)",
      },
