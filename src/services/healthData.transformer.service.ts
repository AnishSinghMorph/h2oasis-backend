...
export class HealthDataTransformer {
  ...
  static transformSleepSummary(
    ...
    console.log(
      "✅ Sleep data transformed:",
      cleanData ? Object.keys(cleanData) : "empty",
    );
    return cleanData;
  }

  static transformPhysicalSummary(
    payload: IRookWebhookPayload,
  ): IPhysicalData | null {
    ...
    const cleanData =
      TransformerUtils.transformPhysicalSummary(physicalSummary);
    console.log(
      "✅ Physical data transformed:",
      cleanData ? Object.keys(cleanData) : "empty",
    );
    return cleanData;
  }
  ...
  static transformBodyMetricsEvent(
    payload: IRookWebhookPayload,
  ): IBodyData | null {
    ...
    const cleanData =
      TransformerUtils.transformBodyMetricsEvent(bodyMetricsEvents);
    console.log(
      "✅ Body metrics event transformed:",
      cleanData ? Object.keys(cleanData) : "empty",
    );
    return cleanData;
  }
